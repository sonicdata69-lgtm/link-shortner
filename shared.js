...
const I18N = {
  ar: {
    ...
    settings_rate: "الأرباح لكل 1000 كليك (دولار)",
    ...
    password_protect_label: "حماية بباسورد (اختياري)",
    password_protect_placeholder: "سيبه فاضي لو مش عايز",
    expiry_label: "تاريخ الانتهاء",
    expiry_none: "بدون",
    expiry_1d: "يوم واحد",
    expiry_7d: "7 أيام",
    expiry_30d: "30 يوم",
    alias_taken: "الاسم ده مستخدم، جرب اسم تاني",
    link_col_dest: "الوجهة",
    qr_btn: "QR",
    stats_btn: "إحصائيات",
    edit_btn: "تعديل",
    delete_btn: "حذف",
    delete_confirm: "متأكد عايز تحذف الرابط ده؟",
    edit_link_title: "تعديل الرابط",
    new_destination_label: "الرابط الأصلي الجديد",
    new_password_label: "باسورد جديد (سيبه فاضي عشان تشيله)",
    save_btn: "حفظ",
    cancel_btn: "إلغاء",
    close_btn: "إغلاق",
    qr_title: "كود QR للرابط",
    stats_title: "إحصائيات الكليكات",
    no_stats: "لسه مفيش كليكات على الرابط ده",
    protected_link_title: "الرابط ده محمي بباسورد",
    enter_password_label: "اكتب الباسورد للمتابعة",
    unlock_btn: "دخول",
    wrong_password: "الباسورد غلط",
    link_expired: "الرابط ده منتهي الصلاحية ⏰",
    referral_title: "ادعُ صحابك واربح",
    referral_desc: "شارك رابط الدعوة بتاعك، وهتاخد 3 دولار مع أول عملية سحب لصاحبك اللي دخل بدعوتك.",
    ...
    referral_bonus_referrer_label: "بونص صاحب الدعوة (دولار) — غير مستخدم حاليًا، البونص بقى ثابت 3$ مع أول سحب للمدعو",
    referral_bonus_referred_label: "بونص المدعو الجديد (دولار) — غير مستخدم حاليًا",
    search_email_placeholder: "بحث بالإيميل",
  ...
  en: {
    ...
    referral_desc: "Share your invite link — you earn $3 when your friend makes their first withdrawal.",
    referral_link_label: "Your invite link",
    referred_count_label: "Friends who joined",
    referral_earned_label: "Earned from referrals",
    referral_bonus_referrer_label: "Referrer bonus (USD) — unused now, bonus is a fixed $3 on referred user's first withdrawal",
    referral_bonus_referred_label: "New user bonus (USD) — unused now",
    search_email_placeholder: "Search by email",
    search_links_placeholder: "Search your links",
    sort_by_clicks: "Most clicked",
...
// ====== security helpers ======
// أي بيانات جايه من المستخدم أو من قاعدة البيانات (إيميل، بيانات حساب، عنوان رابط، اسم مخصص...)
// لازم تعدي على الدالة دي قبل ما تتحط جوه innerHTML، عشان تمنع تنفيذ أكواد HTML/JS خبيثة (XSS).
