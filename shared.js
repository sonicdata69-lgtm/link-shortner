...
const I18N = {
  ar: {
    ...
    referral_desc: "شارك رابط الدعوة بتاعك، وكل ما صاحبك يعمل حساب هتاخد فلوس بونص إنت والتنين.",
    ...
    referral_bonus_referrer_label: "بونص صاحب الدعوة (جنيه)",
    referral_bonus_referred_label: "بونص المدعو الجديد (جنيه)",
  ...
  en: {
    ...
    referral_desc: "Share your invite link — when a friend signs up, you both get a bonus.",
    referral_link_label: "Your invite link",
    referred_count_label: "Friends who joined",
    referral_earned_label: "Earned from referrals",
    referral_bonus_referrer_label: "Referrer bonus (EGP)",
    referral_bonus_referred_label: "New user bonus (EGP)",
